...
router.post('/admin/accept/:walletId' , adminAuth ,  walletControllers.acceptMoney);

router.post('/admin/reject/:walletId' , adminAuth , walletControllers.rejectMoney);

router.get('/admin/wallets/all' , adminAuth , walletControllers.getWallets);

router.get('/admin/wallets/:walletId' , adminAuth , walletControllers.getWalletById);
